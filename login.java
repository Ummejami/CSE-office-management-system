...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(531, 0));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        if(jTextField1.getText().equals("cseoffice") && jPasswordField1.getText().equals("erorr404") && jComboBox1.getSelectedItem().equals("Admin"))
        {
            setVisible(false);
            new home().setVisible(true);
        }
        else if(jTextField1.getText().equals("cseoffice") && jPasswordField1.getText().equals("erorr404") && jComboBox1.getSelectedItem().equals("Teacher"))
        {
            setVisible(false);
